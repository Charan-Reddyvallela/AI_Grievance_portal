...
/** Alternating sections: image background (civic-images 1–8) + overlay. Map section key to image number. */
const SECTION_BG = {
  stats: 7,        // parks / community impact
  features: 3,     // electrical / innovation
  howItWorks: 4,   // public works / process
  departments: 1,  // sanitation / civic services
  priority: 5,     // traffic / urgency
  faq: 6,          // health / support
};

function SectionWithBg({ id, imageNum, overlay = 'bg-white/88', children, className = '' }) {
  return (
    <section id={id} className={`relative overflow-hidden ${className}`}>
      <div
        className="absolute inset-0 bg-cover bg-center"
        style={{ backgroundImage: `url(/civic-images/${imageNum}.jpg)` }}
        aria-hidden
      />
...
const LandingPage = () => {
  ...
  return (
    <PageLayout>
      ...
      <SectionWithBg id="stats" imageNum={SECTION_BG.stats} className="py-24">
      ...
      <section className="py-20 bg-slate-50/80 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_60%_at_80%_50%,rgba(99,102,241,0.06),transparent)]" />
      ...
      <SectionWithBg id="features" imageNum={SECTION_BG.features} className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <SectionWithBg id="how-it-works" imageNum={SECTION_BG.howItWorks} overlay="bg-white/86" className="py-24">
        <div className="absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-indigo-200/60 to-transparent hidden md:block z-10" style={{ transform: 'translateY(-50%)' }} />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="landing-reveal text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-slate-800 mb-4">
              How It Works
      ...
      {/* Departments Section – image bg */}
      <SectionWithBg id="departments" imageNum={SECTION_BG.departments} overlay="bg-white/88" className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="landing-reveal text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-slate-800 mb-4">
      ...
      <section className="py-20 bg-gradient-to-b from-indigo-50/80 to-purple-50/60 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            <h2 className="landing-reveal text-3xl md:text-4xl font-bold tracking-tight text-slate-800 mb-4">
      ...
      {/* Color-Coded Priority System – image bg */}
      <SectionWithBg id="priority" imageNum={SECTION_BG.priority} overlay="bg-white/88" className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="landing-reveal text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-slate-800 mb-4">
      ...
      {/* Rewards Section */}
      <section className="py-24 bg-gradient-to-b from-emerald-50/60 via-white to-teal-50/40 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_50%_80%_at_50%_50%,rgba(16,185,129,0.06),transparent)]" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <h2 className="landing-reveal text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-slate-800 mb-4">
      ...
      {/* FAQ – image bg */}
      <SectionWithBg id="faq" imageNum={SECTION_BG.faq} overlay="bg-white/90" className="py-20 border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="landing-reveal text-2xl md:text-3xl font-bold tracking-tight text-slate-800 mb-2 text-center">
            Frequently Asked Questions
          </h2>
          <p className="landing-reveal landing-reveal-stagger-1 text-slate-600 text-center mb-10">
