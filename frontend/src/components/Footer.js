      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-semibold mb-4">AI Grievance Portal</h3>
            <p className="text-gray-300 mb-4 max-w-md">
              Empowering citizens with AI-powered grievance management. Submit complaints, 
              track progress, and contribute to building better communities through technology.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">support@aigrievance.com</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 AI Grievance Portal. All rights reserved.
            </p>
